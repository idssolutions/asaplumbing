...
export default function Services() {
    const services = [
        ...
        },
        {
            icon: (
                <img
                    src="/faucet-replacement.png"
                    alt="Faucet Replacement"
                    className="w-12 h-12"
                />
            ),
    ...
    return (
        <section className="py-20" id="services">
            <h2 className="mb-6 text-lg font-bold leading-tight md:text-4xl md:leading-tight lg:text-4xl lg:leading-tight font-heading">
                Services
            </h2>
